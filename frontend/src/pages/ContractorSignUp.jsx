      ...
      <div className="auth-right">
        <div className="auth-form">
          ...
          <div className="mb-3">
            ...
            <input type="text" className="form-control auth-input" placeholder="Omar Al-Farsi" />
          </div>

          <div className="mb-3">
            <label className="form-label">Company Name</label>
            <input type="text" className="form-control auth-input" placeholder="Gulf Construction Group" />
          </div>

          <div className="mb-3">
            <label className="form-label">Email Address</label>
            <input type="email" className="form-control auth-input" placeholder="omar@gulfconstruction.com" />
          </div>
